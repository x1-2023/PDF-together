...
const Reader: React.FC = () => {
  ...
  // Refs - Removed mainScrollRef and pageRefs as they are handled by virtualization
  ...
  // Zoom with Ctrl+Scroll - Temporarily disabled for virtualization
  /*
  useEffect(() => {
          ...
          {pdfUrl && numPages > 0 && (
            <VirtualizedSidebar
              ...
              onPageClick={(pageNum) => {
                ...
                // TODO: Implement scroll to page in main canvas
              }}
            />
          )}
        </div>
        ...
        <main className="flex-1 relative bg-gray-100 dark:bg-gray-900 overflow-hidden">
          {pdfUrl ? (
            <Document
              ...
              loading={<div className="animate-pulse text-text-muted p-8">Loading PDF...</div>}
              error={<div className="text-red-500 p-8">Failed to load PDF.</div>}
